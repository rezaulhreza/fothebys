    ...
    <body>
      ...
      @if(auth()->user()->role=='admin')
        ...
        <div>
            ...
            <footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-sm p-4 md:p-6 xl:p-8 my-6 mx-4">
             ...
             <p class="text-center text-sm text-gray-500 my-10">
                &copy; {{now()->year}} <a href="https://themesberg.com" class="hover:underline" target="_blank">Fotheby's</a>. All rights reserved.
             </p>
        </div>
        </div>
        </div>

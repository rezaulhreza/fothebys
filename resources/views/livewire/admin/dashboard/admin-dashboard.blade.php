       ...
       <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <div class="bg-white shadow rounded-sm p-4 sm:p-6 xl:p-8 ">
            <div class="flex items-center">
               <div class="flex-shrink-0">
                  <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900"> {{$faqCount}}</span>
                  <h3 class="text-base font-normal text-gray-500">Frequently Asked Questions</h3>
               </div>
               {{-- <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                  14.6%
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
       ...
       <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
          <div class="bg-white shadow rounded-sm mb-4 p-4 sm:p-6 h-full">
             <div class="flex items-center justify-between mb-4">
                ...
                <a href="#" class="text-sm font-medium text-cyan-600 hover:bg-purple-500rounded-lg inline-flex items-center p-2">
                View all
                </a>
             </div>
             <div class="flow-root">

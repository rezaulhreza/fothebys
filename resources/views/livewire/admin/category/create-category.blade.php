				...
				<div class="form">
						...
						<div class="md:flex flex-row md:space-x-4 w-full text-xs">
							<div class="mb-3 space-y-2 w-full text-xs">
								<label class="font-semibold text-gray-600 py-2">Category Name <abbr title="required">*</abbr></label>
								<input wire:model="name" placeholder="Category Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"  type="text" name="name" id="name">
								...
								<div class="flex-auto w-full mb-1 text-xs space-y-2">
									...
									<textarea wire:model="description" required="" name="description" id="" class="w-full ckeditor form-control min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Enter category dedscription" spellcheck="false"></textarea>

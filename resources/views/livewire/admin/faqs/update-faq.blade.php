                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <div class="flex-auto w-full mb-1 text-xs space-y-2">
                                        <label class="font-semibold text-gray-600 py-2">Answer</label> <abbr title="required">*</abbr>
                                        <textarea wire:model="answer" required="" name="answer" id="" class="w-full ckeditor form-control min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg  py-4 px-4" placeholder="Enter answer" value="{!! $faqs->answer !!}" spellcheck="false">{!! $faqs->answer !!}</textarea>
